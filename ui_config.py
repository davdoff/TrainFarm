...
class UIConfig:
    ...
    ELEMENTS = {
        "task_button": UIElement(
            name="task_button",
            template_path=str(TEMPLATES_DIR / "task.png")
        ),
        "full_task": UIElement(
            name="full_task",
            template_path=str(TEMPLATES_DIR / "FullTask.png")
        ),
        "material_icon": UIElement(
            name="material_icon",
            template_path=str(TEMPLATES_DIR / "iconNextToMaterials.png")
        ),
        "storage": UIElement(
            name="storage",
            template_path=str(TEMPLATES_DIR / "Storage.png")
        ),
    }
