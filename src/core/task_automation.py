...
from src.detectors.template_matcher import find_template_on_screen, find_all_matches, get_scale_factor
from src.config.ui_config import UIConfig
from src.detectors.color_detector import ColorDetector
from src.core.resource_collector import ResourceCollector
from src.core.resource_generator import ResourceGenerator
from src.detectors.task_card_detector import TaskCardDetector
...
from src.config.detection_config import (
    AVERAGE_TRAIN_CAPACITY,
    TRAIN_CAPACITY_ZONE_TOP,
    TRAIN_CAPACITY_ZONE_BOTTOM,
    TRAIN_CAPACITY_ZONE_LEFT,
    TRAIN_CAPACITY_ZONE_RIGHT,
    DELIVER_ZONE_START,
    DELIVER_ZONE_END,
    DELIVER_ZONE_LEFT,
    DELIVER_ZONE_RIGHT,
...
class TaskAutomation:
    ...
    def _find_and_click_blue_button(self) -> bool:
        ...
        # Find all valid blue button candidates
        if contours:
            ...
            if valid_buttons:
                ...
                # Click the highest button
                self.safe_click(highest_button['x'], highest_button['y'])
                return True
    ...
    def run_full_workflow(self):
        ...
        try:
            ...
            collect_tasks_template = "Templates/buttons/CollectButtonTasks.png"
...
# COMMENTED OUT: Interactive game area setup (fullscreen mode only)
...
#
#     # Save to cache
#     from src.config.game_area_cache import save_game_area
...
def main():
    ...
    # COMMENTED OUT: Screen mode selection (now defaults to fullscreen only)
    # # Check for cached game area
    # from src.config.game_area_cache import load_last_game_area, print_config
    #
    ...
    poll_interval = 10  # Check every 10 seconds (time for freebies)

    # Initialize freebie collector
    freebie_collector = FreebieCollector()
