...
class ResourceCollector:
    ...
    def __init__(self):
        ...
        self.collect_button_operator_template = "Templates/buttons/CollectButtonOperator.png"  # May not exist
        self.collect_button_task_template = "Templates/buttons/CollectButtonTask.png"
